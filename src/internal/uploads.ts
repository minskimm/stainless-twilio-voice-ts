...
import type { TwilioVoiceOpenAPI } from '../client';
...
export const maybeMultipartFormRequestOptions = async (
  opts: RequestOptions,
  fetch: TwilioVoiceOpenAPI | Fetch,
 ...
 */
function supportsFormData(fetchObject: TwilioVoiceOpenAPI | Fetch): Promise<boolean> {
